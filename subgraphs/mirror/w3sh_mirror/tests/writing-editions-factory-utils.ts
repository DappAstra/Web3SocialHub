...
} from "../generated/WritingEditionsFactory/WritingEditionsFactory"
...
export function createEditionsDeployedEvent(
  owner: Address,
  clone: Address,
  implementation: Address
): EditionsDeployed {
  let editionsDeployedEvent = changetype<EditionsDeployed>(newMockEvent())

  editionsDeployedEvent.parameters = new Array()

  editionsDeployedEvent.parameters.push(
    new ethereum.EventParam("owner", ethereum.Value.fromAddress(owner))
  )
  editionsDeployedEvent.parameters.push(
    new ethereum.EventParam("clone", ethereum.Value.fromAddress(clone))
